  ...
  <div class="nav-right" @click="logout">
    ...
    <div class="sidebar" v-if="store.isDropdownVisible">
      ...
      <div class="sidebar-list">
        <img src="../assets/icons/members.png" alt="employees icon" class="icon">
        <router-link to="/employeedashboard" class="sidebar-item">Employees</router-link>
      </div>
    <div class="sidebar-list">
      <img src="../assets/icons/orders.png" alt="transport order icon" class="icon">
      <router-link to="/transportdashboard" class="sidebar-item">Transport Orders</router-link>
    </div>
     <div class="sidebar-list">
      <img src="../assets/icons/revenue.png" alt="revenue icon" class="icon">
      <router-link to="/revenuedashboard" class="sidebar-item">Revenue & Profits</router-link>
     </div>
